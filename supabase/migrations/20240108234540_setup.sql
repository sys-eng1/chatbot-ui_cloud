...
AS $$
DECLARE
  project_url TEXT := 'https://gpnpkkraonnotlhuhrme.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImdwbnBra3Jhb25ub3RsaHVocm1lIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTczNDE1Nzg1OSwiZXhwIjoyMDQ5NzMzODU5fQ.-axHh_Lv5Jl3BAMlcadd4XFZJ2BQDPyJL31HfTfnRGo'; -- full access needed for http request to storage
